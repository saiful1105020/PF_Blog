...
<body>
    ...
    <div class="body"></div>
    <div class="header1">Blog</div>
	<div class="grad"></div>
	<div class="header">
		<div>PlayFantasy<span>365</span></div>
	</div>
		
	<br>
	
	<!--
	<form name = "loginForm" method = "post" action="<?php echo site_url('home/entry_proc'); ?>" class="navbar-form navbar-left" role="search">
